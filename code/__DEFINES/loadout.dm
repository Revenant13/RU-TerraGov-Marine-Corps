...
GLOBAL_LIST_INIT(leader_gear_listed_products, list(
		...
		/obj/item/storage/holster/blade/officer/valirapier/full = list(CAT_LEDSUP, "Vali Harvester rapier", 20, "black"),
		//RUTGMC EDIT ADDITION END
		...
		//RUTGMC EDIT ADDITION BEGIN - WEAPONS
		...
		/obj/item/storage/holster/backholster/rpg/full = list(CAT_LEDSUP, "RL-160 Recoilless rifle kit", 20, "black"),
		...
		//RUTGMC EDIT ADDITION BEGIN - MISC.
		/obj/item/cell/lasgun/lasrifle/recharger = list(CAT_LEDSUP, "Terra Experimental recharger battery", 5, "black"),
		/obj/item/jetpack_marine = list(CAT_LEDSUP, "Jetpack", 15, "black"),
		/obj/item/storage/backpack/marine/satchel/scout_cloak/scout = list(CAT_LEDSUP, "Scout Cloak", 15, "black"),
		...
		/obj/item/reagent_containers/hypospray/autoinjector/synaptizine = list(CAT_LEDSUP, "Injector (Synaptizine)", 1, "black"),
		/obj/item/reagent_containers/hypospray/autoinjector/combat_advanced = list(CAT_LEDSUP, "Injector (Advanced)", 2, "orange"),
	))
